...
# This script can be used to generate a web page from a ROOT file
# containing histograms. It is mainly a wrapper setting environment
# variable for the ROOT script which is doing the real work:
# elePublishHistos.C . Command-line arguments and environment
# variables are:
#
# $1 : name of the input ROOT file.
